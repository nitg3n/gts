...
export const highSchoolSelectionSurvey: CleanSurvey = {
  id: "school-selection-v4",
  title: "학교 선택 기준 설문",
  description:
    "현재 중학생의 선택 기준을 바탕으로 고등학교를 추천합니다.",
  audience: "고등학교 진학을 고민하는 중학생",
  ...
  questions: [
    ...
    },
    {
      ...
      step: "profile",
      title: "법적 성별은?",
      description: "입학 가능 학교를 확인하는 데만 사용됩니다.",
      required: true,
      choices: [
        { id: "student-gender-male", label: "남자", value: "male" },
        { id: "student-gender-female", label: "여자", value: "female" },
      ],
    },
    {
      id: "genderPreference",
    ...
    },
    {
      ...
      choices: [
        ...
        { id: "category-gifted", label: "영재학교", value: "영재학교" },
